...
let output = "";
// I suggest you use an object to store the quotes and use array methods to generate the quote
function generate() {
  ...
  switch (number) {
    ...
    case 1:
      output =
        "There are better days ahead! God wants to bring you through, to bring you out even better, and to restore everything you have lost, plus give you more.\n ~Joel Osteen";
      break;
    case 2:
      output =
    ...
    case 14:
      output =
        "There will come a day when it will be your turn. Be patient.\n ~Charlie Valentine";
      break;
    case 15:
